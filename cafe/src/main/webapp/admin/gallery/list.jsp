...
<table border=0 height=1000 width=100%  >
	...
	<tr>
		<td style="vertical-align: top">
			...
			%>
					...
					if(num % 4 ==0){out.print("<tr>");}%>
						...
						<td width = 200 align=center height=250 >
							...
							<b><a href = "view.jsp?code=<%=code%>&uid=<%=uid%>"><input type="checkbox" name = "ap_check" value='<%=uid %>' ><%=numbering %>.<%=subject %><span style="color: blue">[<%=com_count %>]</span><br></a></b>
							<%=name %>
						</td>
						<td width=20></td>
			...
			<table width=1100 align="center">
				<tr>
					<td style="text-align: left"><input type="button" onclick="location.href='list.jsp?code=<%=code%>'" value="새로고침"></td>
					<td style="text-align: right">
						<input type="button" onclick="location.href='write.jsp?code=<%=code%>'" value="글쓰기">
