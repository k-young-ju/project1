	...
	<tr>
		<td>
			...
			<table width=500>
				...
				<tr>
					<td ><input id="name1" name="name1" ></td>
				</tr>
			</table>
			<p></p>
			<table border=0 width=500>	
			...
			<table width=500>	
				...
				<tr>
					<td style="width:30%"><input id="email1" name="email1" style="border:0px" ></td>
					<td>@</td>
					<td ><input id= "email2" name ="email2" style="border:0px" >
			 		</td>
			 		<td>    
			...
			<table border=0 width=500>
				...
				<tr>
					<td ><input id="phone1" name="phone1"></td>
					<td>-&nbsp; </td>
					<td ><input id="phone2" name="phone2"></td>
					<td>-&nbsp; </td>
					<td ><input id="phone3" name="phone3"></td>
				</tr>
			</table>
			<p></p>
			<table width=500>
