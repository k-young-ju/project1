...
mem_email1 = rs.getString("email1");
mem_email2 = rs.getString("email2");
...
function join_ok(){
 ...
 function delete_go(){
	 ...
	 if(result == true){
		 location.href="delete.jsp?code=<%=code%>&id=<%=id%>";
	 }
...
<table border=0 width=500 >
	...
	<tr>
		<td width=350>
		<input id="m_id" name="m_id" value="<%=id %>" readonly style="background-color:#F3EEBF;border:0px">
 		</td>
 	</tr>
</table>
<p></p>
...
<table width=500>
	...
	<tr>
		<td ><input id="name1" name="name1" value="<%=mem_name %>" ></td>
	</tr>
</table>
<p></p>
<table width=500>
	<tr>
		<td class="subject_font"><b>회원등급</b></td>
	</tr>
	<tr>
		<td ><input id="level" name="level" value="<%=level %>"></td>
	</tr>
</table>
<p></p>
<table width=500>	
	...
	<tr>
		<td width=100% >
		<%if(gender.equals("M")){ %>
			<input id ="gender" name = "gender" value="남자" >
		<%}else{ %>
			<input id ="gender" name = "gender" value="여자" >
		<%} %>	
		</td>
	</tr>
</table>
...
<table width=500>
	<tr>
		<td><button style="width:100;height:35px;background-color: white;color:black;font-size:20px" class="subject_font">수정하기</button></td>
		<td><input type="button" style="width:100;height:35px;background-color: white;color:black;font-size:20px" onclick="script:delete_go()" value="삭제하기">
	</tr>
</table>
</center>
