...
String sql_up = "update member set password='"+pass+"',level='"+level+"',name='"+name+"',email1='"+email1+"',email2='"+email2+"',zipcode='"+z+"',zipcode1='"+z1+"',zipcode2='"+z2+"',zipcode3='"+z3+"',zipcode4='"+z4+"',phone1='"+p1+"',phone2='"+p2+"',phone3='"+p3+"' where id='"+id+"'" ;
