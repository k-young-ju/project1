...
<table width=1100 border=1>	
	<tr>
	<%if(gongji.equals("1")){ %>
		<td style="color: red"><b>제목 : 
			<%=rs.getString("subject") %>
		</b></td>
	<%}else{ %>	
		<td style="color: black">제목 : 
			<%=rs.getString("subject") %>
		</td>
	<%} %>	
...
<table width = 1100 align="center" border=0>
	<tr>
		...
		<td align="right">
			...
			<a href = "modify.jsp?code=<%=code%>&uid=<%=uid %>&gongji=<%=gongji%>">[수정]</a>
			<a href = "delete.jsp?code=<%=code%>&uid=<%=uid %>&gongji=<%=gongji%>">[삭제]</a>
