...
function check_select2(){//체크박스 전체 리스트 수가 2개 이상일 때
	...
	location.href="delete_normal.jsp?code=<%=code%>&uids="+check_hide;
	
}
</script>
<table width=1100 border=0>
	<tr>
		<td class="title_font" style = "text-align: left"><b>질문 게시판 Total : <%=total_record %></b></td>
		<td width=350>
			<form method="get">
		...
		<td>
			...
			<table width=550 >
				<tr>
					...
					%>		
						<b><a href="list_normal.jsp?code=<%=code%>&page_now=<%=direct_page%>"><%=direct_page %></a></b>&nbsp;
					<%
					...
					%>	
						&nbsp;<a href="list_normal.jsp?code=<%=code%>&page_now=<%=my_page%>"><img src="img/btn_right.gif"></a>
...
<table width=1100 align="center" border=0>
	<tr>
		<td style="text-align: left"><input type = "button" value="새로고침" onclick="location.href='list_normal.jsp?code=<%=code%>'"></td>
