...
ResultSet rs_count_gongji = stmt_count_gongji.executeQuery(sql_count);
...
out.print(total_record_gongji);


String sql = "select * from "+code+" where gongji !='1' order by fid desc, thread asc"; 
...
String sql_gongji = "select * from "+code+" where gongji ='1' order by fid desc, thread asc";
...
<table width=1100 border=0>
	<tr>
		<td class="title_font" style = "text-align: left"><b>Q&A 게시판 Total : <%=total_record %>+<%=total_record_gongji %></b></td>
		<td width=350>
...
<table width =1100 border=0 >
	<tr>
		<td style="vertical-align: top">
			<table width=500>
				<tr>
					<td colspan = 5 style="text-align: right"><a href = "list.jsp?code=<%=code%>">더보기=></a></td>
				</tr>
			</table>
