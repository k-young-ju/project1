...
<form method="post">
	...
	<table>
		<tr>
			<td style="font-family:'dalla'"><b>아이디</b></td>
		</tr>
		<tr>	
			<td>
				<input id="id" name="m_id" value="<%=id %>" maxlength="12">
			</td>
		</tr>
		<tr>
			<td height=20></td>
		...
		<tr>
			<td align="center"><button style = "width:300px;height:50px;font-family:'dalla';font-size: 30px">비밀번호 찾기</button></td>
		</tr>	
	</table>
	<table >
		<tr>
