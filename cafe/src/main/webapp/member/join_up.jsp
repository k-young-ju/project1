...
<table border=0 >
	<tr>
		...
		<table width=500>	
			...
			<tr>
				<td ><input id="pass1" name="pass1" value="<%=mem_pass%>" maxlength="13"></td>
			</tr>	
		</table>
		<p></p>
		<table width=500>	
			...
			<tr>
				<td ><input id="pass2" name="pass2" value="<%=mem_pass%>" maxlength="13"></td>
			</tr>
		</table>
		<p></p>
		<table width=500>
			...
			<tr>
				<td ><input id="name1" name="name1" value="<%=mem_name %>" readonly style="background-color: #EFEFEF;border:0px" maxlength="20"></td>
			</tr>
		</table>
		<p></p>
		<table width=500>	
		...
		<table border=0 width=500>
			...
			<tr>
				<td ><input id="phone1" name="phone1" value="<%=p1 %>" maxlength="4"></td>
				<td>-&nbsp; </td>
				<td ><input id="phone2" name="phone2" value="<%=p2 %>" maxlength="4"></td>
				<td>-&nbsp; </td>
				<td ><input id="phone3" name="phone3" value="<%=p3 %>" maxlength="4"></td>
			</tr>
		</table>
		<p></p>
		<table width=500>
